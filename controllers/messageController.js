...
const getMessages = async (req, res) => {
  try {
    ...
    //   const decryptedContent = decryptMessage(message.encryptedContent); // Decrypt the message content
    //   return {
    //     ...message.toObject(),
    //     content: decryptedContent, // Replace the content with decrypted content
    //   };
    // });
